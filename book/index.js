...
mongoose.connect('mongodb+srv://lethe:o8qrbgy2zfGsOSF1@cluster0.owdk1.gcp.mongodb.net/BookShop?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true}, function(err){
	if (!err) {
